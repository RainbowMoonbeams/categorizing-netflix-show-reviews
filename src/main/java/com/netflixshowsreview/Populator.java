...
public class Populator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// NetflixShow something = new NetflixShow("Show Name", "imageUrl", "creators",
		// 0000, dramedy, "Stars", "description", "review");

		// comedy:
		NetflixShow unbreakKimmy = new NetflixShow("Unbreakable Kimmy Schmidt", "/images/unbreakable-kimmy-schmidt.jpg",
				"Tina Fey, Robert Carlock", 2015, comedy,
				"Ellie Kemper, Jane Krakowski & Titus Burgess... among others",
		...
		NetflixShow wilfred = new NetflixShow("Wilfred", "/images/wilfred.jpg", "creator", 2011, comedy,
				"Elija Woood... among others",
				"Wilfred is a Netflix Original Comedy "
				...
				"hilarious Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt "
						+ "ut labore et dolore magna aliqua. Ut enim ad minim veniam,quis nostrud exercitation ullamco laboris nisi "
						+ "ut aliquip ex ea commodoconsequat.");
		NetflixShow hatersBackOff = new NetflixShow("Haters Back Off", "/images/haters-back-off.jpg", "creator", 0000,
				comedy, "Coleen... among others",
				"Description:  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
				"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.");

		// drama:
		NetflixShow houseOfCards = new NetflixShow("House of Cards", "/images/houseofcards.jpg", "Beau Willimon", 2013,
				drama, "Kevin Spacey, Robin Wright... among others",
		...
		NetflixShow glow = new NetflixShow("Glow", "/images/glow.jpg", "Liz Flahive, Carly Mensch", 2017, comedy,
				"Alison Brie, Berry Gilpin & Marc Maron... among others",
		...
		NetflixShow flaked = new NetflixShow("Flaked", "/images/flaked.jpg", "Will Arnett, Mark Chappell", 2016,
				dramedy, "Will Arnett, David Sullivan, & Ruth Kearney... among others",
				"Description:  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
				"lorem ipsum asdflj aadslfjaewoij  vajdi;foijawe jfia;weoijf ");
		NetflixShow love = new NetflixShow("Love", "/images/love.jpg", "creator", 2016, dramedy,
				"Gillian Peters, Paul Rust... among others",
				"A boy and girl meet in a convenience store. They hit it off and their relationship turns into a \"thing\""
				...
				"sweet & sour Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt "
						+ "ut labore et dolore magna aliqua. Ut enim ad minim veniam,quis nostrud exercitation ullamco laboris nisi "
						+ "ut aliquip ex ea commodoconsequat.");
		NetflixShow girlboss = new NetflixShow("Girlboss", "/images/girlboss.jpg", "creator", 2017, dramedy, "Stars!",
				"Girlboss is a Netflix Original, loosely based on a true story about"
				...
				"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt "
						+ "ut labore et dolore magna aliqua. Ut enim ad minim veniam,quis nostrud exercitation ullamco laboris nisi "
						+ "ut aliquip ex ea commodoconsequat.");
		NetflixShow santaClarita = new NetflixShow("Santa Clarita Diet", "/images/santa-clarita-diet.jpg", "creator",
				0000, dramedy, "Stars",
				"Description:  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
				"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.");
		NetflixShow unfortEvents = new NetflixShow("A Series of Unfortunate Events", "/images/unfort-events.jpg",
				"creator", 0000, dramedy, "Stars", "Description: ",
				"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.");

		// psycthrill
		NetflixShow theOA = new NetflixShow("The OA", "/images/the-oa.jpg", "creator", 2016, psycThrill, "Starring...",
				"A woman returns home after she went missing for 7 years. "
				...
				"Addicting! Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt "
						+ "ut labore et dolore magna aliqua. Ut enim ad minim veniam,quis nostrud exercitation ullamco laboris nisi "
						+ "ut aliquip ex ea commodoconsequat. ");
		NetflixShow paranoid = new NetflixShow("Paranoid", "/images/paranoid.jpg", "creator", 0000, psycThrill, "Stars",
				"Description: ",
				"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.");
		NetflixShow theFall = new NetflixShow("The Fall", "/images/the-fall.jpg", "creator", 0000, drama, "Stars",
				"Description:  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
				"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.");

		// scifi
		NetflixShow strangerThings = new NetflixShow("Stranger Things", "/images/stranger-things.jpg", "creator", 2016,
				scifi, "Wynona Ryder... among others",
				"Follow a group of pree-teen boys in this "
						...
						+ "leaves you with an eerie feeling...",
				"wicked addicting Lorem ipsum dolor sit amet, consectetur adipisicing elit, "
						+ "sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,quis nostrud "
						+ "exercitation ullamco laboris nisi ut aliquip ex ea commodoconsequat. ");
		NetflixShow blackMirror = new NetflixShow("Black Mirror", "/images/black-mirror.jpg", "creator", 0000, scifi,
				"Stars",
				"Description:  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
				"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.");
